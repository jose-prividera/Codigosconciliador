...
if __name__ == "__main__":
    ...
    try:
        ...
        try:
            ...
            # Exclusión de POS múltiples
            seriales_excluir = ['SMARTPOS1493608722', 'SMARTPOS1491208207','N950NCCB05401029','N950NCCB05401026']
            if 'NÚMERO DE SERIE DEL LECTOR (S/N)' in df_mp.columns:
                df_mp = df_mp[~df_mp['NÚMERO DE SERIE DEL LECTOR (S/N)'].astype(str).str.strip().isin(seriales_excluir)]
